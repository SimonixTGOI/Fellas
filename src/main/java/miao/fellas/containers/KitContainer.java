    ...
    public void openKitContainer(Player player) {
            ...
            try {
                ...
                for(int i = 0; i < kitManager.getKitCount(); i++) {
                    ...
                    lore.add(MessageUtil.color("<yellow>Cooldown: "+ kitTimeManager.getRemainingTime(player.getUniqueId(), kit.getKey(), kit.getCooldown()) + "<dark_purple>/</dark_purple>" +kit.getCooldown() + "s</yellow>")
                            .decoration(TextDecoration.ITALIC, false));
